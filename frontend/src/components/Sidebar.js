    ...
    <div className="flex menu w-[73%] lg:w-auto h-screen flex-col justify-between border-r bg-white">
      <div className="px-4 py-6">
        ...
        <nav aria-label="Main Nav" className="mt-6 flex flex-col space-y-3">
          ...
          <Link
            to="/invoices"
            className={` flex items-center gap-2 rounded-lg px-4 py-2 ${location.pathname==='/invoices'? "bg-gray-100 text-gray-700": "hover:bg-gray-100 hover:text-gray-700 text-gray-500"}`}
          >
            <BsClipboard2DataFill />
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <nav aria-label="Account Nav" className="mt-2 flex flex-col px-4">
              <Link
                to="/expense/fuel"
                className={`flex items-center gap-2 rounded-lg px-4 py-2 ${location.pathname==='/expense/fuel'? "bg-gray-100 text-gray-700": "hover:bg-gray-100 hover:text-gray-700 text-gray-500"}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Link
                to="/expense/other"
                className={`flex items-center gap-2 rounded-lg px-4 py-2 ${location.pathname==='/expense/other'? "bg-gray-100 text-gray-700": "hover:bg-gray-100 hover:text-gray-700 text-gray-500"}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 opacity-75"
