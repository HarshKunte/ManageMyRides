...
function  Sidebar() {
  const {user} = useContext(Context)
    return ( <div className="flex menu h-screen flex-col justify-between border-r bg-white">
    <div className="px-4 py-6">
    <label htmlFor="my-drawer-2" className="lg:hidden btn btn-square btn-ghost">
